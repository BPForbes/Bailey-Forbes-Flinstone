...
| `contracts/networking/contract_p3_wifi.h` | ✅ **#328** / **P4-01** closed | Contract + HE IE parser + lab/physical station path; in-tree SAE/EAPOL/TWT; UART scan/join; FullMAC DHCP/UDP. | ~~**TODO: P3-13 (#279) / P4-01 (#328)**~~ — **`docs/GITHUB_ISSUE_SYNC_P4_WIFI_OTA.md`** |
