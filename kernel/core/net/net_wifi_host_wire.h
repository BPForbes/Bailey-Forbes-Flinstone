#ifndef NET_WIFI_HOST_WIRE_H
#define NET_WIFI_HOST_WIRE_H

/**
 * First-principles Linux hosted Wi-Fi wire constants and layouts (#328).
 *
 * These definitions mirror the kernel netlink / genetlink / nl80211 / AF_PACKET
 * UAPI byte layout used by syscalls. We do not include Linux kernel headers; the
 * shapes and numeric IDs are recorded here for the nl80211 FullMAC shim.
 */
...
#define FL_WIFI_NL80211_BSS_BSSID 0u
#define FL_WIFI_NL80211_BSS_FREQUENCY 1u
#define FL_WIFI_NL80211_BSS_INFORMATION_ELEMENTS 5u
#define FL_WIFI_NL80211_BSS_SIGNAL_MBM 6u
