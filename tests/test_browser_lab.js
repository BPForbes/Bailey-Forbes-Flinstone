...
(async () => {
  ...
  assert(controller.pause()); assert.strictEqual(states.at(-1), STATES.PAUSED);
  assert(controller.resume()); assert.strictEqual(states.at(-1), STATES.READY);
