...
/** Reproducible-builds environment knob name (hosted packaging reviews). */
#define FL_CONTRACT_P7_REPRO_ENV_SOURCE_DATE_EPOCH "SOURCE_DATE_EPOCH"

/** Optional tarball output path cap for lab packaging scripts. */
#define FL_CONTRACT_P7_PACKAGE_ARTIFACT_PATH_MAX_CHARS 4096u
