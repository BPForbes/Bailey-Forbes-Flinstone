...
"  diskput <host_file> [name_on_disk]  Store any host file in FAT32 root (binary; 8.3 / NAME~N.EXT)\n"
"  diskget <name_on_disk> <host_file>  Extract file from FAT32 root to host\n"
"  diskfiles           List files in FAT32 root (includes FLINT.DAT)\n"
"  diskdel <name_on_disk>  Remove file from FAT32 root (not FLINT.DAT)\n"
"\n"
