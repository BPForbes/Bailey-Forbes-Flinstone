...
"  sudo [reason]        Grant elevation (jail escape, protected paths)\n"
"  sudo useradd <u> [p] Add account (needs elevation)\n"
"  sudo userdel <u>     Remove account (needs elevation)\n"
"  sudo passwd [u] <p>  Change password (needs elevation)\n"
