...
SHELL_SRCS = userland/shell/common.c userland/shell/util.c userland/shell/history_record.c userland/shell/audit_log.c userland/shell/ring_log.c userland/shell/shell_authz.c userland/shell/batch_argv.c userland/shell/terminal.c userland/shell/interpreter.c userland/shell/sh.c $(COMMAND_SRCS)
...
TEST_SRCS = BPForbes_Flinstone_Tests.c userland/shell/common.c userland/shell/util.c userland/shell/history_record.c userland/shell/audit_log.c userland/shell/ring_log.c userland/shell/shell_authz.c userland/shell/batch_argv.c userland/shell/terminal.c \
            $(COMMAND_SRCS) \
...
test_invariants: userland/shell/common.o $(UTIL_SHELL_LINK_OBJS) $(MEM_ASM_OBJ) $(HISTORY_ASM_OBJ) $(UTIL_HISTORY_HOST_OBJS) userland/shell/batch_argv.o
	$(CC) $(CFLAGS) $(TEST_SANITIZE) -o tests/test_invariants tests/test_invariants.c userland/shell/common.o $(UTIL_SHELL_LINK_OBJS) $(MEM_ASM_OBJ) $(HISTORY_ASM_OBJ) $(UTIL_HISTORY_HOST_OBJS) userland/shell/batch_argv.o
	./tests/test_invariants

# audit_log unit tests (standalone, no CUnit required)
.PHONY: test_audit_log
test_audit_log: userland/shell/common.o userland/shell/audit_log.o userland/shell/ring_log.o $(UTIL_SHELL_LINK_OBJS) kernel/core/vfs/fs_jail.o kernel/core/mm/mem_domain.o $(MEM_ASM_OBJ) $(HISTORY_ASM_OBJ) $(UTIL_HISTORY_HOST_OBJS)
	$(CC) $(CFLAGS) $(TEST_SANITIZE) -o tests/test_audit_log tests/test_audit_log.c \
	  userland/shell/common.o userland/shell/audit_log.o userland/shell/ring_log.o $(UTIL_SHELL_LINK_OBJS) kernel/core/vfs/fs_jail.o \
