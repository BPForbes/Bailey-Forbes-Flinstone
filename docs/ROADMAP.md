...
| **TODO: P3-13 (#279)** | Wi‑Fi 802.11ax station production tail (**P3-10**): **✅** in-tree OTA path on PR **#334** (`net_wifi_mgmt`, SAE/EAPOL/TWT OTA, `fl_net_dhcp_acquire`, `test_wifi_connect_ota`, optional `mac80211_hwsim`). See **`docs/GITHUB_ISSUE_SYNC_P4_WIFI_OTA.md`**. |
...
| Wi‑Fi | **IEEE 802.11ax-2021** / **802.11i**; **WPA3-SAE**; **RFC 2131** (DHCP after link). **P3-10** contract **✅**; module **✅** in-tree OTA on PR **#334** — **`docs/GITHUB_ISSUE_SYNC_P4_WIFI_OTA.md`**. |
